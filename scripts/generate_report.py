...
def generate_pr_report(data):
    ...
    lines.append("---")
    lines.append("*Generated by devtools-guardian*")
    lines.append("")
...
def generate_guardian_report(prs_data, ci_data, renovate_data, sonar_data):
...
def generate_handoff_report(prs_data, ci_data, renovate_data, sonar_data):
...
def main():
    ...
    if args.mode in SINGLE_INPUT_MODES:
        ...
        if args.mode == "guardian":
            report = generate_guardian_report(prs_data, ci_data, renovate_data, sonar_data)
        else:
            report = generate_handoff_report(prs_data, ci_data, renovate_data, sonar_data)
    else:
